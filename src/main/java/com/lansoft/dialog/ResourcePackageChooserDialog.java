...
/**
 * 从idea源码拷贝而来（com.intellij.ide.util.PackageChooserDialog）
 *
 * @author guowd
 * @date 2021/7/11  3:40
 */
public class ResourcePackageChooserDialog extends PackageChooser {
    ...
    public ResourcePackageChooserDialog(String title, @NotNull Module module) {
    ...
    public ResourcePackageChooserDialog(String title, Project project) {
        super(project, true);
        setTitle(title);
        myTitle = title;
        myProject = project;
    ...
    private DefaultActionGroup createActionGroup(JComponent component) {
        ...
        ResourcePackageChooserDialog.NewPackageAction newPackageAction = new ResourcePackageChooserDialog.NewPackageAction();
    ...
    public String getDimensionServiceKey() {
        return "#com.lansoft.dialog.ResourcePackageChooserDialog";
    }
    ...
    private void createTreeModel() {
        ...
        fileIndex.iterateContent(
                fileOrDir -> {
                    //只改了这么一处 JavaModuleSourceRootTypes.SOURCES   ->  JavaModuleSourceRootTypes.RESOURCES
                    if (fileOrDir.isDirectory() && fileIndex.isUnderSourceRootOfType(fileOrDir, JavaModuleSourceRootTypes.RESOURCES)) {
